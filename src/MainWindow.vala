...
private void on_stop_record_clicked(){
  ...
  private void on_preferences_clicked(){
        ...
        settings.bind("play-last-station-at-startup", play_last_station_switch, "active", GLib.SettingsBindFlags.DEFAULT);
        settings.bind("show-favorite-stations-at-startup", show_favorites_switch, "active", GLib.SettingsBindFlags.DEFAULT);
        settings.bind("not-load-stations-at-startup", not_load_stations_switch, "active", GLib.SettingsBindFlags.DEFAULT);
